...
<head>
    <title>Umroh Libur Lebaran 23 Maret 2026 - Pengenumroh</title>
...
<body class="antialiased">
        ...
        <nav class="flex mb-6 text-sm text-gray-500" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <span class="text-gray-900 font-bold">Umroh Libur Lebaran
                        23 Maret 2026</span>
                </li>
                ...
                <div class="flex flex-col gap-4 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="hidden md:grid md:col-span-1 grid-rows-2 gap-4 h-[700px]">
                            <div class="relative rounded-2xl overflow-hidden cursor-pointer group shadow-sm"
                                onclick="openLightbox(this)">
                                <img src="/assets/img/marketplace/waha-ajyad.jpg"
                                    class="w-full h-full object-cover hover:scale-110 transition duration-500"
                                    alt="Madinah">
                            </div>
                            <div class="relative rounded-2xl overflow-hidden cursor-pointer group shadow-sm"
                                onclick="openLightbox(this)">
                                <img src="/assets/img/marketplace/odst-almadinah.jpg"
                                    class="w-full h-full object-cover hover:scale-110 transition duration-500"
                                    alt="Hotel Room">
                                <!-- <div
                    ...
                    <div class="flex md:hidden gap-3 overflow-x-auto no-scrollbar pb-2">
                        ...
                        <div class="w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden grayscale opacity-70 cursor-pointer"
                            onclick="openLightbox(this)">
                            <img src="/assets/img/marketplace/waha-ajyad.jpg" class="w-full h-full object-cover">
                        </div>
                        <div class="w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden grayscale opacity-70 cursor-pointer"
                            onclick="openLightbox(this)">
                            <img src="/assets/img/marketplace/odst-almadinah.jpg" class="w-full h-full object-cover">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            <span
                                ...
                                Reguler 12 Hari</span>
                            <h1 class="text-2xl md:text-4xl font-bold text-gray-900 leading-tight">Umroh Libur Lebaran
                                23 Maret 2026</h1>
                            <div class="flex items-center gap-2 mt-2 text-gray-500 text-sm">
                                <i class="ph-fill ph-calendar-blank text-orange-500 text-lg"></i> <span>23 Maret
                                    2026</span>
                                <span class="mx-1">•</span>
                                <i class="ph-fill ph-clock text-orange-500 text-lg"></i> <span>12 Hari</span>
                            </div>
                        </div>
                    </div>
                ...
                <section id="hotel" class="scroll-mt-40">
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition">
                        ...
                        <div class="mt-5 flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-start">
                                    <h4 class="text-lg font-bold text-gray-800">Odst Almadinah</h4>
                                    <span class="flex text-yellow-400 text-xs">⭐⭐⭐⭐⭐</span>
                                </div>
                                <p class="text-sm text-gray-500 mt-1 flex items-center gap-1"><i
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Tiket Pesawat International (PP)</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Makan 3x</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Ziarah Makkah & Madinah</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Muthawif</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Pembimbing Ibadah</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Zam Zam 5L</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Tahalul</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Albaik Chicken</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Perlengkapan Umroh</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">Manasik dan Lounge</p>
                                    </div>
                                </div>
                    ...
                    <div class="relative timeline-line space-y-8 pl-2">
                        <div class="relative pl-10">
                            ...
                            <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <h4 class="text-lg font-bold text-gray-900 mt-1">Keberangkatan jakarta - Jeddah - Makkah
                                </h4>
                                <p class="text-gray-600 text-sm mt-2">Keberangkatan dan melaksanakan Umroh</p>
                            </div>
                        </div>
                        <div class="relative pl-10">
                            <div
                            ...
                            <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <p class="text-gray-600 text-sm mt-2">Memperbanyak Ibadah di Masjidil Haram</p>
                            </div>
                        </div>
                        ...
                        <div id="extra-itinerary" class="hidden space-y-8">
                            <div class="relative pl-10">
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        3</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Makkah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Ziarah Kota Makkah</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        4</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Makkah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Ziarah kota Thaif</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        5</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Makkah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Shalat Jum'at dan memperbanyak Ibadah di
                                        Masjid Nabawi</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                            ...
                            <div class="relative pl-10">
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        7</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Makkah - Madinah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Melanjutkan Perjalanan ke Madinah</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    ...
                                    <p class="text-gray-600 text-sm mt-2">Memperbanyak Ibadah di Masjid Nabawi</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        9</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Madinah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Ziarah Kota Madinah</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                            ...
                            <div class="relative pl-10">
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        11</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Madinah - Jeddah</h4>
                                    <p class="text-gray-600 text-sm mt-2">Persiapan Kepulangan</p>
                                </div>
                            </div>
                            <div class="relative pl-10">
                                <div
                                ...
                                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                                    <span class="text-xs font-bold text-orange-600 uppercase tracking-wider">Hari
                                        12</span>
                                    <h4 class="text-lg font-bold text-gray-900 mt-1">Kepulangan Jeddah - Jakarta</h4>
                                    <p class="text-gray-600 text-sm mt-2">Kepulangan</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Rp 31,9 Jt/pax</p>
                                    </div>
                                </div>
                                <div class="flex items-center bg-white border border-gray-200 rounded-lg p-1 shadow-sm">
                                    ...
                                    <input type="number" id="qty-quad" value="1" data-name="Quad" data-price="31900000"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Rp 33,4 Jt/pax</p>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Rp 35,4 Jt/pax</p>
                                    </div>
                                </div>
                                <div class="flex items-center bg-gray-50 border border-gray-200 rounded-lg p-1">
    ...
    <div
        ...
        <div class="flex flex-col flex-1 min-w-0 pr-1">
            ...
            <span class="text-base font-extrabold text-orange-600 truncate" id="total-price-mobile">Rp 31.9 Jt</span>
        </div>
