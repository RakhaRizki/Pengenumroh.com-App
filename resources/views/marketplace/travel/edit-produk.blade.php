...
<head>
    <title>Edit Produk - Pengenumroh</title>
...
<body class="text-slate-800 antialiased selection:bg-orange-500 selection:text-white">
                ...
                <div class="lg:col-span-1 space-y-6" data-aos="fade-right">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                        <nav class="flex flex-col">
                            ...
                            <div class="bg-orange-50 border-l-4 border-orange-600">

                                <a href="{{ route('marketplace.travel.kelola-produk') }}"
                                    class="flex items-center gap-3 px-5 py-3 text-slate-600 hover:text-orange-900 transition group">
                                    <i
                                        class="ph-bold ph-package text-xl group-hover:scale-110 transition-transform"></i>
                                    <span class="font-bold">Kelola Produk</span>
                                </a>

                                <div class="flex items-center gap-2 pl-12 pb-4 pr-5">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                            <div class="flex items-center gap-3">
                                <a href="/marketplace/travel/kelola-produk/"
                                    class="bg-white border border-slate-200 p-2.5 rounded-xl text-slate-500 hover:text-orange-600 hover:border-orange-200 transition shadow-sm">
                                    <i class="ph-bold ph-arrow-left text-lg"></i>
                                </a>
                                <div>
                                    <h1 class="text-2xl font-bold text-slate-900">Edit Produk</h1>
                                    <p class="text-slate-500 text-sm mt-1">Perbarui informasi paket perjalanan Anda.</p>
                                </div>
                            </div>
                            <div class="hidden md:flex gap-3">
                                ...
                                <button type="submit"
                                    class="px-6 py-2.5 rounded-xl bg-orange-600 text-white font-bold hover:bg-orange-700 shadow-lg shadow-orange-500/20 transition flex items-center gap-2 text-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
                                <h3 class="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">
                                    <i class="ph-duotone ph-broadcast text-red-500 text-xl"></i> Status Produk
                                </h3>
                                <div
                                    class="flex flex-col md:flex-row justify-between items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="p-3 bg-white rounded-full border border-slate-200 text-orange-600 shadow-sm">
                                            <i class="ph-bold ph-eye text-xl"></i>
                                        </div>
                                        <div>
                                            <h4 class="font-bold text-slate-900 text-sm">Status Penayangan</h4>
                                            <p class="text-xs text-slate-500 mt-1 max-w-sm">
                                                Matikan tombol ini untuk menyembunyikan produk sementara (Draft/Arsip).
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
                                ...
                                <div class="flex gap-4 mb-4 overflow-x-auto pb-4 px-1 no-scrollbar"
                                    id="preview-container">
                                    <div
                                        class="relative w-28 h-28 flex-shrink-0 rounded-xl overflow-hidden border border-slate-200 bg-slate-100 group shadow-sm transition hover:scale-105">
                                        <img src="/assets/img/marketplace/produk-dummy.png"
                                            class="w-full h-full object-cover">
                                        <button type="button"
                                            class="absolute top-1.5 right-1.5 bg-white p-1.5 rounded-full text-red-500 hover:bg-red-500 hover:text-white shadow-md transition transform scale-0 group-hover:scale-100">
                                ...
                                <div class="border-2 border-dashed border-slate-300 rounded-xl p-4 text-center hover:bg-slate-50 hover:border-orange-400 transition cursor-pointer flex flex-col items-center justify-center gap-2 group"
                                    onclick="document.getElementById('product-images').click()">
                                    <div
                                        class="bg-orange-50 text-orange-500 p-2 rounded-full group-hover:scale-110 transition">
                                        <i class="ph-bold ph-plus text-xl"></i>
                                    </div>
                                    <span class="text-sm font-bold text-slate-600">Tambah Foto Baru</span>
                                ...
                                <div class="space-y-8">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="space-y-2 md:col-span-2">
                                            ...
                                            <input type="text" value="Umroh Awal Ramadhan 9 Hari - Hotel Bintang 5"
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="relative">
                                                ...
                                                <select
                                                    ...
                                                    <option value="Reguler" selected>Umroh Reguler</option>
                                                    <option value="VIP">Umroh Plus / VIP</option>
                                                    <option value="Haji">Haji Khusus</option>
                                                    <option value="Tour">Halal Tour</option>
                                                </select>
                                                <i
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <ul id="list-included" class="space-y-2">
                                                ...
                                                <li
                                                    class="flex justify-between items-center bg-green-50 px-3 py-2 rounded-lg border border-green-100">
                                                    <span class="text-sm text-green-800 font-medium">Visa Umroh</span>
                                                    <button onclick="this.parentElement.remove()"
                                                        class="text-green-400 hover:text-red-500 transition"><i
                                                            class="ph-bold ph-x"></i></button>
                                                </li>
                                                <li
                                                    class="flex justify-between items-center bg-green-50 px-3 py-2 rounded-lg border border-green-100">
                                                    <span class="text-sm text-green-800 font-medium">Handling Bandara &
                                                        Hotel</span>
                                                    <button onclick="this.parentElement.remove()"
                                                        class="text-green-400 hover:text-red-500 transition"><i
                                                            class="ph-bold ph-x"></i></button>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <ul id="list-excluded" class="space-y-2">
                                                ...
                                                <li
                                                    class="flex justify-between items-center bg-red-50 px-3 py-2 rounded-lg border border-red-100">
                                                    <span class="text-sm text-red-800 font-medium">Vaksin
                                                        Meningitis</span>
                                                    <button onclick="this.parentElement.remove()"
                                                        class="text-red-400 hover:text-red-600 transition"><i
                                                            class="ph-bold ph-x"></i></button>
                                        ...
                                        <div id="itinerary-container"
                                            ...
                                            <div class="relative pl-6 pb-8 itinerary-item">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-between mb-2">
                                                        <input type="text" value="Keberangkatan Jakarta - Jeddah"
                                                    ...
                                                    <textarea rows="2"
                                                        class="w-full bg-white px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-orange-500 transition resize-none">Berkumpul di Bandara Soekarno Hatta Terminal 3 Ultimate untuk persiapan keberangkatan menuju Jeddah.</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="relative pl-6 pb-8 itinerary-item">
                                                ...
                                                <div
                                                    class="bg-slate-50 border border-slate-200 rounded-xl p-4 group hover:border-orange-200 transition">
                                                    <div class="flex justify-between mb-2">
                                                        <input type="text" value="Tiba di Madinah & Ziarah Dalam"
                                                            class="w-full bg-transparent font-bold text-slate-800 text-sm focus:outline-none placeholder:text-slate-400">
                                                        <button type="button" onclick="removeDay(this)"
                                                            class="text-slate-400 hover:text-red-500 transition"
                                                            title="Hapus Hari">
                                                    ...
                                                    <textarea rows="2"
                                                        class="w-full bg-white px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-orange-500 transition resize-none">Tiba di Madinah, Check-in Hotel. Dilanjutkan dengan Ziarah Raudhah dan Makam Rasulullah SAW.</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div class="space-y-2 transition-all duration-300 md:col-span-2"
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <input type="text" value="Garuda Indonesia (GA980)"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="text-center p-2 hidden" id="placeholder-makkah">
                                                <i
                                            ...
                                            <img id="preview-makkah" src="/assets/img/marketplace/hotel-makkah.jpg"
                                                onerror="this.src='https://placehold.co/400x200?text=Hotel+Makkah'"
                                                class="absolute inset-0 w-full h-full object-cover pointer-events-none">

                                            <div
                                                class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover/upload:opacity-100 transition duration-300">
                                                <p class="text-white text-xs font-bold"><i
                                                        class="ph-bold ph-pencil-simple"></i> Ganti Foto</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-3">
                                            <div class="space-y-1.5">
                                                ...
                                                <input type="text" value="Pullman Zamzam Makkah"
                                            ...
                                            <div class="space-y-1.5">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <input type="text" value="0m (Pelataran Masjid)"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="text-center p-2 hidden" id="placeholder-madinah">
                                                <i
                                                    class="ph-bold ph-image text-2xl text-slate-300 group-hover/upload:text-orange-500 transition mb-1"></i>
                                                <p
                                                    class="text-xs font-bold text-slate-400 group-hover/upload:text-orange-600 transition">
                                            ...
                                            <img id="preview-madinah" src="/assets/img/marketplace/hotel-madinah.jpg"
                                                onerror="this.src='https://placehold.co/400x200?text=Hotel+Madinah'"
                                                class="absolute inset-0 w-full h-full object-cover pointer-events-none">
                                        ...
                                        <div class="space-y-3">
                                            <div class="space-y-1.5">
                                                <label class="text-xs font-semibold text-slate-500">Nama Hotel</label>
                                                <input type="text" value="Anwar Al Madinah Mövenpick"
                                                    class="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-orange-500 bg-white transition shadow-sm focus:shadow-md">
                                            </div>
                                            <div class="space-y-1.5">
                                                <label class="text-xs font-semibold text-slate-500">Bintang</label>
                                            ...
                                            <div class="space-y-1.5">
                                                ...
                                                <div class="relative">
                                                    <i
                                                        class="ph-bold ph-person-simple-walk absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                                    <input type="text" value="50m (Pintu Utama)"
                                                        class="w-full pl-10 pr-3 py-2.5 rounded-lg border border-slate-200 text-sm focus:outline-none focus:border-orange-500 bg-white transition shadow-sm focus:shadow-md">
                                                </div>
                                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="text-[10px] font-bold bg-slate-100 text-slate-500 px-2 py-0.5 rounded">Sekamar
                                                Ber-4</span>
                                        </div>
                                        <div class="relative">
                                            <span
                                                class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-bold">Rp</span>
                                            <input type="text" value="30.000.000" oninput="formatCurrency(this)"
                                                class="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 transition">
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                        ...
                                        <div class="relative">
                                            <span
                                                class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-bold">Rp</span>
                                            <input type="text" value="32.500.000" oninput="formatCurrency(this)"
                                                class="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 transition">
                                        </div>
                                    </div>
                                    <div class="space-y-2 md:col-span-2">
                                        ...
                                        <div class="relative">
                                            <span
                                                class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-bold">Rp</span>
                                            <input type="text" value="35.000.000" oninput="formatCurrency(this)"
                                                class="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 transition">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="md:hidden pt-4 pb-8 space-y-3">
                                ...
                                <a href="/marketplace/travel/kelola-produk/"
                                    class="block text-center w-full py-3.5 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition">
                                    Batal
                                </a>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Cek dulu apakah elemennya ada (untuk mencegah error di halaman lain)
            if (toggle && label) {

                toggle.addEventListener('change', function () {
                    if (this.checked) {
                        // --- JIKA DIAKTIFKAN (TAYANG) ---
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Produk Ditayangkan',
                            text: 'Produk ini sekarang terlihat oleh calon jamaah.',
                        ...
                        // --- JIKA DIMATIKAN (DRAFT) ---
                        label.textContent = "Draft (Arsip)";
                        label.classList.replace('text-slate-700', 'text-slate-400');

                        // Notifikasi
                        Swal.fire({
                            icon: 'info',
                            title: 'Produk Diarsipkan',
                            text: 'Produk disembunyikan dari hasil pencarian.',
                            showConfirmButton: false,
                            position: 'center',
                            timer: 1500
                        });
    ...
    <script>
        ...
        toggle.addEventListener('change', function () {
            if (this.checked) {
                ...
                label.textContent = "Non-Aktif (Draft)";
                label.classList.replace('text-slate-700', 'text-slate-400');
            }
        });
    </script>
