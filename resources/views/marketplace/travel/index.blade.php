...
<body class="text-slate-800 antialiased selection:bg-orange-500 selection:text-white">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
                            ...
                            <div class="flex items-center gap-6 mb-8 pb-8 border-b border-slate-100">
                                <div class="relative group cursor-pointer">
                                    <div
                                        class="w-24 h-24 rounded-full overflow-hidden bg-slate-100 border-2 border-slate-200 group-hover:border-orange-500 transition">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-3">
                                        <button type="button" onclick="document.getElementById('file-input').click()"
                                            class="text-sm font-bold text-orange-600 hover:bg-orange-50 px-3 py-1.5 rounded-lg transition">Ubah
                                            Foto</button>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="space-y-2">
                                    <label class="text-sm font-bold text-slate-700">Nama Travel/Biro</label>
                                    <div class="relative">
                                        <i
                                            class="ph-duotone ph-buildings absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="text" value="Haramainku Travel"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-envelope absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="email" value="rahmatrio@gmail.com"
                                            class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 text-slate-500 text-sm font-medium focus:outline-none bg-slate-50 cursor-not-allowed"
                                            readonly title="Email tidak dapat diubah">
                                        <span
                                            class="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] bg-green-100 text-green-700 px-2 py-0.5 rounded font-bold flex items-center gap-1">
                                ...
                                <div class="md:col-span-2 border-t border-slate-100 pt-4">
                                    ...
                                    <p class="text-xs text-slate-400 mt-1 ml-10">Digunakan untuk keperluan pencairan
                                        dana komisi/travel.</p>
                                </div>

                                <div class="space-y-2">
                                    <label class="text-sm font-bold text-slate-700">Nama Bank</label>
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-buildings absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <select
                                ...
                                <div class="space-y-2">
                                    <label class="text-sm font-bold text-slate-700">Nomor Rekening</label>
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-credit-card absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="number" value="1234567890"
                                            class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 transition"
                                            placeholder="Contoh: 5220304xxx">
                                    </div>
                                </div>

                                <div class="space-y-2 md:col-span-2">
                                    <label class="text-sm font-bold text-slate-700">Atas Nama Pemilik Rekening</label>
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-identification-badge absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="text" value="Rahmat Rio"
                                            class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 transition"
                                            placeholder="Nama sesuai buku tabungan">
                                    </div>
                                    <p class="text-[11px] text-slate-400 flex items-start gap-1.5 mt-1.5 ml-1">
                                        <i class="ph-fill ph-info text-orange-400 mt-0.5"></i>
                                        <span>Pastikan nama sesuai dengan buku tabungan untuk kelancaran transaksi
                                            pencairan.</span>
                                    </p>
                                </div>
                            ...
                            <!-- <div class="border rounded-xl p-5 bg-slate-50 border-slate-200 mb-6">
                                <div class="flex items-center justify-between cursor-pointer"
                                    ...
                                    <i id="passport-icon"
                                        class="ph-bold ph-caret-down text-slate-400 transition-transform duration-300"></i>
                                </div>

                                <div id="passport-form"
                                    class="hidden mt-5 pt-5 border-t border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-6 transition-all">
                                    <div class="space-y-2">
    ...
    <script>
        ...
        // 1. Date Picker untuk Tanggal Lahir
        ...
        function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    // Update preview di sidebar & navbar (Simulasi instant update)
        ...
        // 3. Reset Avatar Logic
        function resetAvatar() {
            const defaultAvatar = "https://ui-avatars.com/api/?name=Rakha+Rizki&background=F97316&color=fff";
        ...
        function confirmLogout() {
            Swal.fire({
                ...
                text: "Anda harus masuk kembali untuk mengakses Profil",
                icon: 'warning',
                iconColor: '#dc2626',
