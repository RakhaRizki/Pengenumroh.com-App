                        ...
                        <div class="relative z-10">
                            ...
                            <div class="mt-4 text-left">
                                ...
                                <div class="w-full bg-slate-100 rounded-full h-2">
                                    <div class="bg-orange-500 h-2 rounded-full transition-all duration-1000 w-[80%]">
                                    </div>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-user absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="text" value="Rakha Rizki"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-identification-card absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="number" value="3276012209980001"
                                            class="form-input w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-sm font-medium focus:outline-none transition"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" value="rakharizki@gmail.com"
                                        ...
                                        <span
                                            class="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] bg-green-100 text-green-700 px-2 py-0.5 rounded font-bold">Terverifikasi</span>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-whatsapp-logo absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-calendar absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <input type="text" id="birth-date" value="1998-09-22"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <i
                                            class="ph-bold ph-gender-intersex absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg"></i>
                                        <select
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <div class="relative">
                                        <textarea rows="3"
                                            ...
                                            placeholder="Masukkan alamat lengkap (Nama Jalan, No Rumah, RT/RW, Kelurahan, Kecamatan)">Jl. Kebahagiaan No. 12, RT 01/05, Depok, Jawa Barat</textarea>
                                    </div>
                                </div>
